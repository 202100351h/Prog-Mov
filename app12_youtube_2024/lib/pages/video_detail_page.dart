...
class VideoDetailPage extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            FutureBuilder<List<String>>(
              future: videoModel.id.videoId != null
                  ? fetchComments(videoModel.id.videoId!)
                  : Future.value([]),
  ...
  Future<List<String>> fetchComments(String videoId) async {
    final response = await http.get(
      Uri.parse(
          'https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&videoId=$videoId&key=AIzaSyBuzuDZE9bPH0F70M-it5SQMenmTS9KD-w'),
    );
    ...
    if (response.statusCode == 200) {
      ...
      for (var item in jsonData['items']) {
        comments
            .add(item['snippet']['topLevelComment']['snippet']['textDisplay']);
      }
      return comments;
    } else {
